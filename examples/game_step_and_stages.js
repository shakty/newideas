/**
 * This files describes how to specify a game, stages and steps, their options and their meaning.
 * 
 */
...
(function(node, channel) {
	...
	// Optional, but important properties are 'descr', 'init', 'done', and 'onfail', etc. that can added in the game step definition

	var creation = {
			id: 'creation',
			cb: function() {},
			env: {}, // specific variables for this step to pass in runtime. They overwrite temporarily the gloabal node.env variables
			...
			onpconnect: function(p) {}, 	// a player connected
			onpdisconnect: function(p) {}, 	// a player disconnected. If a player disconnects during the game it is different, than during the instructions
			minplayers: 3, // the minimum number of players to play this step
			maxplayers: 5 // the maximum number of players to play this step 
	};
